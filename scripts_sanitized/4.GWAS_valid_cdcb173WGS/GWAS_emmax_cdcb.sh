...
## SNP dataset
cd ${PROJECT_ROOT}/pangenie_cdcb/7.gatk
...
# C:\Users\${USER}\OneDrive - University of Maryland\Data\2024-02-07.cattleLR-SR-GWAS\4.2.sig.anno> scp ${CLUSTER_HOST}:${PROJECT_ROOT}/pangenie_cdcb/3.pan_all/All2_BTAN_WGS.sv.bed.gz .
